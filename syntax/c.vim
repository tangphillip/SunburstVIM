...
" Updaters:     Phil Tang (pt) <tangphillip@gmail.com>
" Changes:      (pt) Added a hook to highlight '#define'
"               (pt) Added hooks to highlight function declarations and uses
...
" Match '#define' only.
syn match   cSharpDefine    "^\s*\(%:\|#\)\s*define"
syn match   cDefinedKeyword "^\s*\(%:\|#\)\s*define\s*\w\+" contains=cSharpDefine

" Match functions and classes.
syn match   cCustomParen    "(" contains=cParen "contained containedin=cCustomFunc,cCustomFuncCall 
syn match   cCustomFunc "\w\+\s*(" contains=cCustomParen
syn match   cCustomFuncCall "\w\+\s*(" contained containedin=cBlock contains=cCustomParen
syn match   cCustomScope    "::" transparent
...
hi def link cCustomFuncCall Function
hi def link cCustomFunc Function
hi def link cCustomClass    Function
hi def link cSharpDefine    Define
